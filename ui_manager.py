...
class Button:
    def __init__(self, rect, label, callback, font,
        ...
        self.text_surface_normal = self.font.render(
            self.label, True, self.normal_color
        )
        self.text_surface_selected = self.font.render(
            self.label, True, self.selected_color
        )
    ...
    def draw(self, screen, selected=False):
        ...
        text_surface = (
            self.text_surface_selected if selected else self.text_surface_normal
        )
