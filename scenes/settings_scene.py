...
class SettingsScene(BaseScene):
    ...
    def on_enter(self) -> None:
        ...
        # Create the theme selection layer with a refresh callback.
        theme_layer = ThemeSelectionLayer(self.config, self.font, self.layer_manager, refresh_callback=self.refresh_scene)
